...
- (void)drawGradientaLayerAmination
{
    ...
    for(int i=10;i>=0;i-=2) {
        [tempArray addObject:(__bridge id)[KUIColorFontColor_Hong colorWithAlphaComponent:i*.1f].CGColor];
    }
...
- (UIImageView *)imageView
{
    if (nil == _imageView) {
        ...
        _imageView.tintColor = KUIColorFontColor_Hong;
        //self.showConfig.tintColor ;
