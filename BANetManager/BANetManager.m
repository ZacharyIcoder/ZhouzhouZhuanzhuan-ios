                           ...
                           progressBlock:(BADownloadProgressBlock)progressBlock
{
    ...
    //    NSLog(@"请求URL: %@/%@",URLString, imageEntity.parameters);
    NSLog(@"\n********************************************************");
                             ...
                             index:(NSUInteger)index
{
    ...
    {   // 图片数据不为空才传递 fileName
        ...
        NSString *imageFileName = [NSString stringWithFormat:@"%@%lu.%@",str, (unsigned long)index, imageType?:@"jpg"];
        
        [formData appendPartWithFileData:imageData
                                    name:[NSString stringWithFormat:@"picflie%lu", (unsigned long)index]
